...
def dashboard1():
    st.markdown("""
                <div><h1 style='text-align: center; margin-bottom: 50px; text-decoration: underline;'>Stroke Analysis and Risk 
                Factors</h1></div>""", unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
                    <div><p style='font-size: 20px;text-align: justify;'>Private jobs have been associated with a higher 
                    incidence of stroke, with 66 cases reported in urban areas and 61 cases in rural areas.</p></div""", 
                    unsafe_allow_html=True)
        st.markdown("""
                    <div><p style='font-size: 20px;text-align: justify;'>Private employment frequently entails high-stress settings 
                    with demanding workloads, constrained deadlines, and lengthy workdays.</p></div>""", unsafe_allow_html=True)
        st.markdown("""
                    <div><p style='font-size: 20px;text-align: justify;'>Employees in private sector occupations sometimes spend 
                    lengthy periods of time sitting at a desk or in front of a computer, doing little or no physical exercise.
    ...
    with col2:
        ...
        st.write("")
        st.markdown("""
                    <div><p style='font-size: 20px;text-align: justify;'>The analysis reveals that the majority of stroke 
                    cases (89%) occurred among married individuals, while only a small proportion (11%) were reported among unmarried
                      individuals.</p></div>""", unsafe_allow_html=True)
        st.markdown("""
                    <div><p style='font-size: 20px;text-align: justify;'>Relationship problems and caregiving obligations are only 
                    two stressors that being married may bring about. These stressors can raise stress levels and may even increase 
                    the risk of stroke.</p></div>""", unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.write("")
        st.markdown("""
                    <div><p style='font-size: 20px;text-align: justify;'>Based on the chart, it is observed that females 
                    experience higher levels of stress compared to males. It is important to note that stress is a known risk 
                    factor for stroke.</p></div>""", unsafe_allow_html=True)
        st.markdown("""
                    <div><p style='font-size: 20px;text-align: justify;'>Females could have particular socioeconomic obstacles 
                    including childcare duties, work-life balance, and gender inequality at work. They may experience more stress 
                    due to hormonal changes, notably those that occur during menstruation, pregnancy, and menopause.</p></div>""", 
                    unsafe_allow_html=True)
    
    # Add a line at the bottom
    st.markdown("<hr style='border: 1px solid #ddd;'>", unsafe_allow_html=True)
    st.markdown("""
                <div><p style='font-size: 20px;text-align: justify;'>Combining these claims, the study implies that variances 
                in stroke risk may be influenced by elements including stress from one's job, marital status, and gender differences 
                in stress levels. It emphasises how crucial it is to deal with stress management and encourage social support 
                networks in order to reduce stroke risk factors.</p></div>""", unsafe_allow_html=True)
...
def dashboard2():
    st.markdown(
         """
        <div>
        <h1 style='text-align: center; margin-bottom: 50px; text-decoration: underline;'
        >Health Metrics and Lifestyle Analysis Dashboard
        </h1>
        </div>
        """, unsafe_allow_html=True)
    st.markdown("---")
    ...
    """
    <div>
    <p style='font-size: 21px;text-align: justify;'>The scatter plot and column chart are the two charts that 
    make up this dashboard. The first graph, a scatter plot illustrates the relationship between the average 
    ...
    with col1:
       ...
       The chart shows that the average glucose level increases as BMI increases.
       </p>
       </div>
       """, unsafe_allow_html=True)
       ...
       <div>
       <p style='font-size: 21px;text-align: justify;'
       >This might be because of insulin resistance, a condition where the body's cells become less responsive to
       the effects of insulin, is frequently linked to higher BMI. Blood glucose levels are controlled by insulin, 
       and when cells become resistant to insulin, glucose may build up in the bloodstream and cause glucose levels 
       to rise.
       </p>
       </div>
       """, unsafe_allow_html=True)
       ...
       family history, lifestyle choices, and general health state.</p>
    ...
    with col1:
       ...
       <div>
       <p style='font-size: 21px;text-align: justify;'>
       Three to four times sugary intake recorded the highest average of exercise in a week
       </p></div>""", unsafe_allow_html=True)
       ...
       <div>
       <p style='font-size: 21px;text-align: justify;'>
       We can see that male are more active in exercise compare to female. 
       This might be because of males often have more muscular mass and testosterone in their bodies, 
       ...
       <div>
       <p style='font-size: 21px;text-align: justify;'>
       From this chart we see that students at UiTM practice a healthy lifestyle with most of them consuming sugary foods 
       only three to four times a week following the highest exercise rate. </p>
       </div>""", unsafe_allow_html=True)
    ...
    st.markdown(
       ...
       <div>
       <p style='font-size: 21px;text-align: justify;'>
       From the two charts we can conclude that adopting a healthy lifestyle is very important in our lives, 
       having a normal BMI can ensure that our glucose levels are in a normal state, this can be done by 
       controlling how much we consume sugary foods and drinks and how much we practice exercise.</p>
       </div>""", unsafe_allow_html=True)
...
def dashboard3():
    ...
    with col2:
        st.markdown("")
        st.markdown("""
                    <div><p style='font-size: 21px;text-align: justify;'>Urban residents with private work types have the largest 
                    numbers of stroke occurrences when compared to other groups.</p></div>""", unsafe_allow_html=True)
        st.markdown("""
                    <div><p style='font-size: 21px;text-align: justify;'>Urban areas frequently have higher levels of air pollution 
                    due to reasons such as increasing car traffic and the presence of manufacturers. </p></div>""", 
                    unsafe_allow_html=True)
        st.markdown("""
                    <div><p style='font-size: 21px;text-align: justify;'>Dietary trends in urban areas may differ from those in 
                    rural areas, with a larger consumption of processed foods, harmful fats, and a higher intake of sodium.</p></div>""", 
                    unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.write("")
        st.markdown("""
                    <div><p style='font-size: 21px;text-align: justify;'>WP Kuala Lumpur regularly has the greatest number 
                    of stroke cases per year when compared to other states.
                    </p></div>""", unsafe_allow_html=True)
        st.markdown("""
                    <div><p style='font-size: 21px;text-align: justify;'>The surrounding area's bustling and congested 
                    environment generate stress and hence raise the probability of stroke.</p></div>""", unsafe_allow_html=True)
        st.markdown("""
                    <div><p style='font-size: 21px;text-align: justify;'>The high cost of living in WP Kuala Lumpur adds 
                    to the financial load, magnifying stress levels among residents and likely contributing to the region's 
                    increased stroke incidence.</p></div>""", unsafe_allow_html=True)
    ...
    st.markdown(
        ...
        <div>
        <p style='font-size: 21px;text-align: justify;'>
        We may conclude from the information shown in the dashboard that urban regions, particularly WP Kuala Lumpur, have the 
        largest number of stroke incidents when compared to other locations. This can be ascribed to a variety of factors, 
        including rising air pollution, dietary trends, high living costs and stress. These factors combine and lead to the 
        increased total stroke incidence seen in urban areas such as WP Kuala Lumpur.
        </p>
        </div>
        """,
        unsafe_allow_html=True
